...
public final class Lab_2 {
	...
	public static void main (String[] args) {
		...
		// Point3d p1
		System.out.print("Введите координату x точки 1: ");
		x = in.nextDouble();
		...
		// Point3d p2
		System.out.print("Введите координату x точки 2: ");
		x = in.nextDouble();
		...
		System.out.println("Третья точка вводится автоматически с координатами (0,0,0) !");
		...
		if (p1.equals(p2) || p1.equals(p3) || p2.equals(p3)) {
			System.out.println("Точки находятся в одном и том же месте !");
		}
		else {
